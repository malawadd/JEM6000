...
<template>
	<Flex direction="column" gap="16" :class="$style.wrapper">
		...
		tx.hash.slice(-4)
					...
					<Text size="14" weight="500" height="140" color="tertiary" mono> Method: {{ tx.method }}
					</Text>
					<Text size="13" weight="600" color="support" mono :class="$style.when"> Events: {{ tx.eventCount }}
					</Text>
				</Flex>
			</Flex>
		</a>
